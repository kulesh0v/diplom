...
На графиках \ref{ch2-ris} и \ref{ch2_1} видно, что значения выходных сигналов $y_1, y_2$ достигают отслеживаемых значений $y_1^s, y_2^s$. Следовательно, замкнутый контур в схеме из главы \ref{chap2} рекурсивно осуществим и экспоненциально устойчив.
