...
Рассмотрим пример, который описывает систему из четырёх сообщающихся резервуаров \cite{Berberich}.
...
\includegraphics{images/four-tank-system_rus.png}}
...
\caption{Результаты программной реализации схемы из главы \ref{chap2}}
}
\end{figure}

На графике видно, что значения выходных сигналов $y_1, y_2$ достигают отслеживаемых значений $y_1^s, y_2^s$. Следовательно, замкнутый контур в схеме из главы \ref{chap2} рекурсивно осуществим и экспоненциально устойчив.

\newpage

\begin{figure}[bh]\centering{
\includegraphics[width=150mm]{images/chap3.eps}}
\caption{Результаты программной реализации схемы из главы \ref{chap3}}
\end{figure}

По результатам программной реализации схемы из главы \ref{chap3} можно сделать вывод, что, при наличии зашумлений в условиях задачи, замкнутый контур относительно уровня шума практически экспоненциально устойчив.
